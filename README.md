...
| `baseline_plots.py` | Runs all six methods on both baseline scenarios and plots the result. | Figures 4.1, 4.2, Appendix B |
...
| `Change_point_magnitude_sweep.py` | Sweeps mean-shift magnitude (with KL-matched variance-change magnitude) and plots detection rate and EDD. | Figures 4.3, 4.4 |
| `Change_point_duration_sweep.py` | Sweeps change duration at a fixed magnitude and plots detection rate and EDD. | Figures 4.5, 4.6 |
